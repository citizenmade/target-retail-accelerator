//function to prevent rubber-banding on iPhone while still allowing scrollable divs
//credited to stackoverflow user RandallB: http://stackoverflow.com/users/551828/randallb
//more info found here: http://stackoverflow.com/questions/10357844/how-to-disable-rubber-band-in-ios-web-apps

(function registerScrolling($m) {
    var prevTouchPosition = {},
        scrollYClass = 'scroll-y',
        scrollXClass = 'scroll-x',
        searchTerms = '.' + scrollYClass + ', .' + scrollXClass;

    $m('body').on('touchstart', function (e) {
        var $scroll = $m(e.target).closest(searchTerms),
...
$m('body').on('touchmove', function (e) {
