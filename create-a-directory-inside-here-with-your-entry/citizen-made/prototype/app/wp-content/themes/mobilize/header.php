...
<div id="home-page" data-role="page">
	...
	<div data-role="header" class="page-header">
        	<div class="logo">
        	<a href="<?php echo $lurl; ?>" data-ajax="false"><img src="<?php get_option_tree("logo",'',true); ?>" width="<?php get_option_tree("logo_w",'',true); ?>" height="<?php get_option_tree("logo_h",'',true); ?>" /></a>
        </div>
	</div>
    <!--/header --> 
    <?php }else {?> 
<div data-role="page">
 <!-- header -->
	<div data-role="header" class="page-header" >
    	<a href="<?php echo home_url('/'); ?>" data-icon="arrow-l" data-iconpos="notext" data-direction="reverse" data-rel="back">Back</a>
      <div class="logo">
        	<a href="<?php echo $lurl;?>" data-ajax="false"><img src="<?php get_option_tree("logo",'',true); ?>" width="<?php get_option_tree("logo_w",'',true); ?>" height="<?php get_option_tree("logo_h",'',true); ?>" /></a>
        </div>
    	<a href="<?php echo home_url('/'); ?>" data-icon="home" data-iconpos="notext" rel="external" class="ui-btn-right">Home</a>
	</div>
    <!--/header -->
    <?php }} ?>
