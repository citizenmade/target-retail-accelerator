...
= 1.1.7 =
Lots of additions, none critical just fun. Added layouts & upload to slider. As mobilize, started including action hooks for extending and integrating with other plugins.
